...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Kalychain address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Kalychain account at a particular block.
    type Account {
    ...
    # Transaction is an Kalychain transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Kalychain account at the current block's state.
    ...
    type Query {
        # Block fetches an Kalychain block by number or by hash. If neither is
